      ...
      <div style={{width:'100%',display:'flex',flexDirection:'row',justifyContent:'center'}}>
        <div id="cards">
          <TechContext.Provider value={{ tech: tech, setTech: setTech }}>
            ...
            <Profile work={true}>
                I'm a Computer Scientist who's interested in programming language theory and data systems. I find nothing more satisfying than finding a simple and effective solution to a complex problem.
            </Profile>
            <Technologies 
              display={[
                "rust",
